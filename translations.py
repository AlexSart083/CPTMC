...
TRANSLATIONS = {
    'en': {
        ...
        'accumulation_phase': '📊 Accumulation Phase (Real Values)',
        'accumulation_phase_real': '📊 Accumulation Phase (Real Values)',
        'accumulation_phase_nominal': '💰 Accumulation Phase (Nominal Values)',
        'final_values': '🏁 Final Values',
        'percentile': 'Percentile',
        'value_euro': 'Value (€)',
        'median': 'Median',
        'average': 'Average',
        'distribution_accumulation': 'Distribution of End-of-Accumulation Values (Real)',
        'distribution_accumulation_real': 'Distribution of End-of-Accumulation Values (Real)',
        'distribution_accumulation_nominal': 'Distribution of End-of-Accumulation Values (Nominal)',
    ...
    'it': {
        ...
        'accumulation_phase': '📊 Fase di Accumulo (Valori Reali)',
        'accumulation_phase_real': '📊 Fase di Accumulo (Valori Reali)',
        'accumulation_phase_nominal': '💰 Fase di Accumulo (Valori Nominali)',
        'final_values': '🏁 Valori Finali',
        'percentile': 'Percentile',
        'value_euro': 'Valore (€)',
        'median': 'Mediana',
        'average': 'Media',
        'distribution_accumulation': 'Distribuzione dei Valori di Fine Accumulo (Reali)',
        'distribution_accumulation_real': 'Distribuzione dei Valori di Fine Accumulo (Reali)',
        'distribution_accumulation_nominal': 'Distribuzione dei Valori di Fine Accumulo (Nominali)',
